---
title: "3.1 CUDA Reduce算子优化"
description: "Reduce（规约）是 GPU 编程中最基础、也最能体现并行思维的算子之一"
pubDate: 2026-05-18
category: "cuda-optimization"
order: 301
chapter: 3
tags: ["CUDA", "Reduce Kernel", "算子优化", "并行计算"]
---
...
<img src="/AIInfraGuide/images/reduce-cuda-kernel-01.png" alt="CUDA programming model" style="max-width: 90%; display: block; margin: 0 auto;" />
...
<img src="/AIInfraGuide/images/reduce-cuda-kernel-02.png" alt="CUDA programming model" style="max-width: 90%; display: block; margin: 0 auto;" />
...
<img src="/AIInfraGuide/images/reduce-cuda-kernel-03.png" alt="reduce-cuda-kernel-03" style="max-width: 90%; display: block; margin: 0 auto;" />
...
<img src="/AIInfraGuide/images/reduce-cuda-kernel-04.png" alt="reduce-cuda-kernel-04" style="max-width: 90%; display: block; margin: 0 auto;" />
